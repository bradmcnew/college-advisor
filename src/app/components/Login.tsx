...
export const LoginPage = () => {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-linear-to-r from-blue-50 via-blue-100 to-white px-4 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        {/* Hero Image */}
